...
class Geojson2Controller extends Controller
{
    ...
    public function index()
    {
        ...
        $data = Menu::leftJoin('geojson_categories', function ($join) {
    ...
    public function edit($id)
    {
        ...
        $load['data'] = $data;
        $load['menu'] = Menu::get();
        $load['category'] = GeojsonCategory::where('menu', $data->menu_id)->get();
        //dd($load);
    ...
    public function update(Request $request, $id)
    {
        ...
        //$postVal['menu'] = $request->menu;
        $postVal['category'] = $request->category;
        $postVal['geojson_name'] = $request->name;
        $postVal['geojson_color'] = $request->fill_color;
        $postVal['geojson_opacity'] = $request->fill_opacity;

        //dd($id);
        Geojson::where('geojson_id', $id)->update($postVal);
        

        $request->session()->flash('success', 'Edit Data Suksess');
        return redirect()->route('geojson.show',$id);
    }
