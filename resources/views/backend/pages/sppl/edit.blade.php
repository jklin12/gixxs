...
<div class="panel panel-inverse" data-sortable-id="table-basic-1">
    ...
    <div class="panel-body">
        ...
        @endforeach
        @endif
        <form action="{{ route('sppl.update',$data->sppl_id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="form-group row m-b-15">
                <label class="col-form-label col-md-3">Nama</label>
                <div class="col-md-9">
                    <input type="texxt" class="form-control m-b-5" placeholder="Masukan Nama" name="nama" value="{{ $data->sppl_name }}">
                </div>
            </div>
