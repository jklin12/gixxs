...
<div class="panel panel-inverse" data-sortable-id="table-basic-1">
    ...
    <div class="panel-body">
        ...
        @endforeach
        @endif
        <form action="{{ route('file_share.update',$data->file_share_id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="form-group row m-b-15">
                <label class="col-form-label col-md-3">Menu</label>
                <div class="col-md-9">
                    <select class="form-control" name="menu" value="" id="edit-menu">
                        <option value=""></option>
            ...
            <div class="form-group row m-b-15">
                ...
                <div class="col-md-9">
                    <input type="texxt" class="form-control m-b-5" placeholder="Masukan Judul" name="title" value="{{ $data->file_share_title }}">
                </div>
            </div>
...
<script>
    $('#edit-menu').val('<?= $data->file_share_menu  ?>').change()
</script>
@endpush