...
<div class="panel panel-inverse" data-sortable-id="table-basic-1">
    ...
    <div class="panel-body">
        ...
        @endforeach
        @endif
        <form action="{{ route('proker.update',$data->proker_id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
            ...
            <div class="form-group row m-b-15">
                ...
                <div class="col-md-9">
                    <input type="texxt" class="form-control m-b-5" placeholder="Masukan Judul" name="proker_title" value="{{ $data->proker_title }}">
                </div>
            </div>
            ...
            <div class="form-group row m-b-15">
                ...
                <div class="col-md-9">
                    <textarea class="ckeditor" id="editor1" name="proker_body" rows="20">{{ $data->proker_body }}</textarea>
                </div>
            </div>
...
<script>
     $('#edit-ref').val('<?= $data->ref_proker_id  ?>').change()
</script>
@endpush